...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::get('masakan', [MasakanController::class, 'index'])->name('masakan');
...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::get('user/{id}', [UserController::class, 'indexProfile'])->name('userProfile');
});
...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::get('order/detail/{id_order}', [Detail_OrderController::class, 'index'])->name('detail_order');
